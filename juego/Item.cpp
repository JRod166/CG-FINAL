...
void Item::dibujar()
{
  ...
  switch (tipo)
  {
    case (1): //vida extra
      ...
      glVertex3f(x+radio_hitbox, y-radio_hitbox,-3-tipo);   //bottom-right
      glTexCoord2f(0.111111,1);
      glVertex3f(x+radio_hitbox, y+radio_hitbox,-3-tipo); //top-right
      glTexCoord2f(0,1);
      glVertex3f(x-radio_hitbox, y+radio_hitbox,-3-tipo); //top-left
      glTexCoord2f(0,1-0.186047);
      glVertex3f(x-radio_hitbox, y-radio_hitbox,-3-tipo); //bottom-left
      break;
